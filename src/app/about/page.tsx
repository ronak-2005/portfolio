        ...
        <div className="about-grid">
          <div className="about-content">
            ...
            <div className="about-text">
              <p className="lead">
                I'm an aspiring <strong>Machine Learning Engineer</strong> with
                a background in
              ...
              <p>
                ...
                scalable machine learning systems. I’m always curious to explore
                new tools, frameworks, and ideas that push me to grow as an
                engineer.
              </p>
            </div>
            ...
            <div className="about-profile">
              <div className="profile-image">
                <div className="project-placeholder">
                  <img className="project-placeholder" src="profile.jpeg"></img>
                </div>
              </div>
          </div>
        </div>
